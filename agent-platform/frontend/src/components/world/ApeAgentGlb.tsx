...
import { ApeAgentModel, type ApeClip, type ApeJersey } from "./ApeAgentModel";
...
export function ApeAgentGlb({
  id, position, rotation, scale = 1, status = "idle", selected = false, onClick, clip = null, color, jersey = null,
}: ApeAgentProps & { clip?: ApeClip | null; jersey?: ApeJersey | null }) {
  ...
  return (
    ...
    >
      ...
      <ApeAgentModel status={status} clip={clip} accent={color ?? null} jersey={jersey} />
