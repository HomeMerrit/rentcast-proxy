...
const baseField =
  "w-full rounded-xl bg-surface border border-line-strong px-3.5 text-sm text-content placeholder:text-content-subtle " +
  "transition-all duration-200 outline-none focus:border-iris-500 focus:shadow-[0_0_0_3px_rgba(237,113,80,0.14)] " +
